...
tree = etree.parse('/Users/ilyabarinov/SkillFactory/Объектно-ориентированное программирование/C5.4. Парсинг данных с сайтов с помощью lxml/k.html', lxml.html.HTMLParser())  # попытаемся спарсить наш файл с помощью html-парсера. Сам html - это то, что мы скачали и поместили в папку из браузера.
